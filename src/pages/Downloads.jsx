...
const versions = [
  {
    ...
    platforms: [
      { os: '🪟 Windows', arch: '64-bit', href: 'http://www.firebirdsql.org/en/firebird-5-0-3/' },
      { os: '🪟 Windows', arch: '32-bit', href: 'http://www.firebirdsql.org/en/firebird-5-0-3/' },
      { os: '🐧 Linux', arch: '64-bit (.tar.gz)', href: 'http://www.firebirdsql.org/en/firebird-5-0-3/' },
      { os: '🐧 Linux', arch: '64-bit (.rpm)', href: 'http://www.firebirdsql.org/en/firebird-5-0-3/' },
      { os: '🐧 Linux', arch: '64-bit (.deb)', href: 'http://www.firebirdsql.org/en/firebird-5-0-3/' },
      { os: '🍎 macOS', arch: '64-bit', href: 'http://www.firebirdsql.org/en/firebird-5-0-3/' },
    ],
    releaseNotes: 'https://www.firebirdsql.org/file/documentation/release_notes/Firebird-5.0.3-ReleaseNotes.pdf',
  },
  {
    name: 'Firebird 4.0.6',
    status: 'LTS',
    ...
    platforms: [
      { os: '🪟 Windows', arch: '64-bit', href: 'http://www.firebirdsql.org/en/firebird-4-0-6/' },
      { os: '🪟 Windows', arch: '32-bit', href: 'http://www.firebirdsql.org/en/firebird-4-0-6/' },
      { os: '🐧 Linux', arch: '64-bit (.tar.gz)', href: 'http://www.firebirdsql.org/en/firebird-4-0-6/' },
      { os: '🐧 Linux', arch: '64-bit (.rpm)', href: 'http://www.firebirdsql.org/en/firebird-4-0-6/' },
      { os: '🐧 Linux', arch: '64-bit (.deb)', href: 'http://www.firebirdsql.org/en/firebird-4-0-6/' },
      { os: '🍎 macOS', arch: '64-bit', href: 'http://www.firebirdsql.org/en/firebird-4-0-6/' },
    ],
    releaseNotes: 'https://www.firebirdsql.org/file/documentation/release_notes/Firebird-4.0.6-ReleaseNotes.pdf',
  },
  {
    name: 'Firebird 3.0.13',
    status: 'Întreținere',
    statusClass: 'badge-maintenance',
    date: '2025-07-15',
    desc: 'Versiune în faza de întreținere. Sunt furnizate numai corecții de securitate critice.',
    platforms: [
      { os: '🪟 Windows', arch: '64-bit', href: 'http://www.firebirdsql.org/en/firebird-3-0-13/' },
      { os: '🐧 Linux', arch: '64-bit', href: 'http://www.firebirdsql.org/en/firebird-3-0-13/' },
      { os: '🍎 macOS', arch: '64-bit', href: 'http://www.firebirdsql.org/en/firebird-3-0-13/' },
    ],
    releaseNotes: 'https://www.firebirdsql.org/file/documentation/release_notes/Firebird-3.0.13-ReleaseNotes.pdf',
  },
];
